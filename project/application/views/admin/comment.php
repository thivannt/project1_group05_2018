...
<body>
		...
		<div class="card">
		  ...
		  <div class="card-body">
			   <ul class="list-group list-group-flush">
			    ...
			    <li class="list-group-item"><a href="<?= base_url() ?>new_controller/GetData""><i class="fas fa-comment"></i> Quản lý comment</a></li>
	...
	<div class="right">
			<nav class="navbar navbar-light bg-light mb-4">
			  <form  action="<?= base_url() ?>/comment/getAllComment" method="get" class="form-inline ml-auto">
				...
				<div class="row">
					...
					<div class="col-sm-4 mb-3">
						<div class="card-body">
							...
							<div class="icon">
												<a href="<?= base_url() ?>comment/deleteComment/<?= $value['id'] ?>">
												<button type="button" class="btn btn-outline-danger fas fa-trash-alt"></button>
												</a>
												
												<div class="reply">
													<form action="<?= base_url() ?>comment/updateReply/<?= $value['id'] ?>" method="post">
